...
const Home = () => {
  ...
  const featuredProjects = [
    ...
    },
    {
      ...
      problem: 'Cardiac patients have no easy way to track how their condition evolves over time. They need a platform to upload reports, visualize health trajectories, and get actionable AI-driven guidance.',
      system: 'Web app where users upload medical reports → RAG pipeline indexes and retrieves relevant medical context → Agentic AI analyzes longitudinal patient data, identifies worsening patterns, and provides personalized recommendations to help reduce disease progression. Backed by deep learning models (BiLSTM, BiGRU, Transformer) trained on MIMIC-IV ICU data.',
      decisions: 'Built RAG for grounding AI responses in the user\'s own medical history. Agentic AI orchestrates retrieval, trajectory analysis, and recommendation generation. Users interact conversationally — upload reports, ask questions, and track trends over time.',
      challenges: 'Handling diverse medical report formats for reliable parsing. Ensuring AI recommendations are safe and grounded in retrieved data. Building intuitive trajectory visualization so non-technical users can understand their health trends.',
      results: { 'AUC-ROC': '0.9096', 'Platform': 'Upload + Trajectory + AI', 'Models': 'BiLSTM / BiGRU / Transformer' },
